...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="mt-4">
                <h3 class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['staff_count'])); ?></h3>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="mt-4">
                <a href="<?php echo e(route('admin.messenger')); ?>" class="text-lg font-bold text-gray-900 hover:text-blue-600">پیام‌رسان</a>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="mt-4">
                <a href="<?php echo e(route('admin.staff.index')); ?>" class="text-lg font-bold text-gray-900 hover:text-blue-600">مدیریت پرسنل</a>
    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        <div class="text-center">
            ...
            <div class="flex justify-center gap-4">
                <a href="<?php echo e(route('admin.messenger')); ?>" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                    ورود به پیام‌رسان
                </a>
                <a href="<?php echo e(route('admin.staff.index')); ?>" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                    مدیریت پرسنل
                </a>
            </div>
        </div>
