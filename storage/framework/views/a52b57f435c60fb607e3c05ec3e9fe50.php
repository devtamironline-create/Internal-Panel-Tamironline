<?php $__env->startSection('page-title', 'مدیریت تسک‌ها'); ?>
...
<div class="space-y-6" x-data="kanbanBoard()">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('tasks.my')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                </svg>
                تسک‌های من
            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentTeam): ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-2">
        <div class="flex flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('tasks.index', ['team' => $team->slug])); ?>"
                class="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition
                    <?php echo e($currentTeam && $currentTeam->id === $team->id ? 'bg-'.$team->color.'-100 text-'.$team->color.'-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($team->icon_svg); ?>"/>
                </svg>
                <?php echo e($team->name); ?>

                <span class="text-xs bg-<?php echo e($currentTeam && $currentTeam->id === $team->id ? $team->color.'-200' : 'gray-200'); ?> px-2 py-0.5 rounded-full">
                    <?php echo e($team->tasks()->whereNotIn('status', ['done'])->count()); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-4">
        <form method="GET" action="<?php echo e(route('tasks.index')); ?>" class="flex flex-wrap items-center gap-4">
            <input type="hidden" name="team" value="<?php echo e($currentTeam->slug); ?>">
            ...
            <div class="flex items-center gap-2">
                ...
                <select name="assignee" onchange="this.form.submit()" class="text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring-brand-500">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($member->id); ?>" <?php echo e(request('assignee') == $member->id ? 'selected' : ''); ?>>
            ...
            <div class="flex items-center gap-2">
                ...
                <select name="priority" onchange="this.form.submit()" class="text-sm rounded-lg border-gray-300 focus:border-brand-500 focus:ring-brand-500">
                    <option value="">همه</option>
                    <option value="urgent" <?php echo e(request('priority') == 'urgent' ? 'selected' : ''); ?>>فوری</option>
                    ...
                    <option value="low" <?php echo e(request('priority') == 'low' ? 'selected' : ''); ?>>کم</option>
                </select>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('assignee') || request('priority')): ?>
            <a href="<?php echo e(route('tasks.index', ['team' => $currentTeam->slug])); ?>" class="text-sm text-red-600 hover:text-red-700">
                پاک کردن فیلترها
            </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-gray-100 rounded-xl p-4 min-h-[500px]"
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-2">
                    <span class="w-3 h-3 rounded-full bg-<?php echo e($column['color']); ?>-500"></span>
                    <h3 class="font-bold text-gray-900"><?php echo e($column['label']); ?></h3>
                </div>
                <span class="text-sm text-gray-500"><?php echo e($column['tasks']->count()); ?></span>
            </div>

            <!-- Tasks -->
            <div class="space-y-3" id="column-<?php echo e($status); ?>">
                ...
                <div class="task-card bg-white rounded-lg shadow-sm p-4 cursor-pointer hover:shadow-md transition"
                    ...
                    @click="openTaskModal(<?php echo e($task->id); ?>)">

                    <!-- Priority Badge -->
                    <div class="flex items-center justify-between mb-2">
                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-<?php echo e($task->priority_color); ?>-100 text-<?php echo e($task->priority_color); ?>-700">
                    ...
                    <div class="mb-2">
                        <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
                            <span>چک‌لیست</span>
                            <span><?php echo e($progress['completed']); ?>/<?php echo e($progress['total']); ?></span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-1.5">
                            <div class="bg-green-500 h-1.5 rounded-full" style="width: <?php echo e($progress['percentage']); ?>%"></div>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-100">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full bg-brand-500 flex items-center justify-center text-white text-xs">
                                <?php echo e(mb_substr($task->assignee->first_name ?? 'U', 0, 1)); ?>

                            </div>
                            <span class="text-xs text-gray-500"><?php echo e($task->assignee->first_name); ?></span>
                        </div>
                        <?php else: ?>
                        ...
                        <span class="text-xs <?php echo e($task->is_overdue ? 'text-red-600' : 'text-gray-500'); ?>">
...
function kanbanBoard() {
    return {
        ...
        newTask: {
            ...
            due_date: '',
            priority: 'medium',
            team_id: '<?php echo e($currentTeam?->id); ?>'
        },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Tamironline-CRM/Modules/Task/Resources/views/index.blade.php ENDPATH**/ ?>