<?php $__env->startSection('page-title', 'تنظیمات حضور و غیاب'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('attendance.admin')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
    ...
    <form action="<?php echo e(route('attendance.settings.update')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <input type="time" name="work_start_time" value="<?php echo e($settings->work_start_time); ?>"
                ...
                <div>
                    ...
                    <input type="time" name="work_end_time" value="<?php echo e($settings->work_end_time); ?>"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">تلرانس تاخیر (دقیقه)</label>
                    <input type="number" name="late_tolerance_minutes" value="<?php echo e($settings->late_tolerance_minutes); ?>" min="0"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <input type="number" name="lunch_duration_minutes" value="<?php echo e($settings->lunch_duration_minutes ?? 30); ?>" min="0" max="120"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center gap-2 px-4 py-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                        <input type="checkbox" name="working_days[]" value="<?php echo e($num); ?>"
                            <?php echo e(in_array($num, $workingDays) ? 'checked' : ''); ?>

                            class="rounded text-blue-600 focus:ring-blue-500">
                        <span class="text-sm text-gray-700"><?php echo e($name); ?></span>
                    </label>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="flex flex-wrap gap-4 mb-6">
                ...
                <label class="flex items-center gap-2 px-4 py-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input type="checkbox" name="verification_methods[]" value="trust"
                        <?php echo e(in_array('trust', $methods) ? 'checked' : ''); ?>
                ...
                <label class="flex items-center gap-2 px-4 py-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input type="checkbox" name="verification_methods[]" value="ip"
                        <?php echo e(in_array('ip', $methods) ? 'checked' : ''); ?>
                ...
                <label class="flex items-center gap-2 px-4 py-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input type="checkbox" name="verification_methods[]" value="gps"
                        <?php echo e(in_array('gps', $methods) ? 'checked' : ''); ?>
                ...
                <label class="flex items-center gap-2 px-4 py-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input type="checkbox" name="verification_methods[]" value="selfie"
                        <?php echo e(in_array('selfie', $methods) ? 'checked' : ''); ?>
            ...
            <div class="border-t pt-6 mb-6">
                ...
                ><?php echo e($settings->allowed_ips ? implode("\n", $settings->allowed_ips) : ''); ?></textarea>
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="allowed_location_lat" value="<?php echo e($settings->allowed_location_lat); ?>"
                            placeholder="مثال: 35.6892"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-500 mb-1">طول جغرافیایی (Longitude)</label>
                        <input type="text" name="allowed_location_lng" value="<?php echo e($settings->allowed_location_lng); ?>"
                            placeholder="مثال: 51.3890"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-500 mb-1">شعاع مجاز (متر)</label>
                        <input type="number" name="allowed_location_radius" value="<?php echo e($settings->allowed_location_radius ?? 100); ?>"
                            min="10" max="1000"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                    ...
                    <select name="salary_type" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="monthly" <?php echo e($settings->salary_type == 'monthly' ? 'selected' : ''); ?>>ماهانه</option>
                        <option value="hourly" <?php echo e($settings->salary_type == 'hourly' ? 'selected' : ''); ?>>ساعتی</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">ضریب اضافه‌کاری</label>
                    <input type="number" name="overtime_rate" value="<?php echo e($settings->overtime_rate ?? 1.40); ?>"
                ...
                <div>
                    ...
                    <input type="number" name="late_deduction_per_minute" value="<?php echo e($settings->late_deduction_per_minute ?? 0); ?>"
                        min="0"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">کسر غیبت (ریال/روز)</label>
                    <input type="number" name="absence_deduction_per_day" value="<?php echo e($settings->absence_deduction_per_day ?? 0); ?>"
                        min="0"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
            </div>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(route('attendance.admin')); ?>" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                انصراف
            </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Tamironline-CRM/Modules/Attendance/Providers/../Resources/views/attendance/settings.blade.php ENDPATH**/ ?>