...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'داشبورد'); ?> | Hostlino</title>
            ...
            <nav class="flex-1 overflow-y-auto no-scrollbar py-6">
                <div>
                    ...
                    <ul class="flex flex-col gap-2 mb-6">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.customers.index')); ?>" class="py-3 border-b border-slate-100w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.customers.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                        ...
                        <!-- مدیریت هاست - Submenu -->
                        <li x-data="{ open: <?php echo e(request()->routeIs('admin.services.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.product-categories.*') || request()->routeIs('admin.product-addons.*') || request()->routeIs('admin.servers.*') ? 'true' : 'false'); ?> }">
                            <button @click="open = !open" class="py-3 border-b border-slate-100 w-full flex flex-row items-center justify-between gap-2 menu-item <?php echo e(request()->routeIs('admin.services.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.product-categories.*') || request()->routeIs('admin.product-addons.*') || request()->routeIs('admin.servers.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                            ...
                            <ul x-show="open" x-collapse class="pr-4 mt-1 space-y-1">
                                <li>
                                    <a href="<?php echo e(route('admin.services.index')); ?>" class="py-2 w-full flex flex-row items-center gap-2 menu-item text-sm <?php echo e(request()->routeIs('admin.services.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.products.index')); ?>" class="py-2 w-full flex flex-row items-center gap-2 menu-item text-sm <?php echo e(request()->routeIs('admin.products.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.product-categories.index')); ?>" class="py-2 w-full flex flex-row items-center gap-2 menu-item text-sm <?php echo e(request()->routeIs('admin.product-categories.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.product-addons.index')); ?>" class="py-2 w-full flex flex-row items-center gap-2 menu-item text-sm <?php echo e(request()->routeIs('admin.product-addons.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.servers.index')); ?>" class="py-2 w-full flex flex-row items-center gap-2 menu-item text-sm <?php echo e(request()->routeIs('admin.servers.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.invoices.index')); ?>" class="py-3 border-b border-slate-100 w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.invoices.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.tickets.index')); ?>" class="py-3 border-b border-slate-100 w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.tickets.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-2 mb-6">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.reports.index')); ?>" class="py-3 border-b border-slate-100 w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.reports.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                                گزارش‌ها
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.import.index')); ?>" class="py-3 border-b border-slate-100 w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.import.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.settings')); ?>" class="py-3 border-b border-slate-100 w-full flex flex-row items-center gap-2 menu-item <?php echo e(request()->routeIs('admin.settings*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute left-0 mt-4 w-60 rounded-2xl border border-gray-200 bg-white p-3 shadow-lg dark:border-gray-800 dark:bg-gray-900">
                                ...
                                <ul class="space-y-1">
                                    ...
                                    <li><a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5">تنظیمات</a></li>
                                </ul>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hosting-crm/resources/views/layouts/admin.blade.php ENDPATH**/ ?>