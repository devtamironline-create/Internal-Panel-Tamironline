<?php $__env->startSection('page-title', 'تسک جدید'); ?>
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('tasks.index', ['team' => $currentTeam?->slug])); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
    ...
    <form action="<?php echo e(route('tasks.store')); ?>" method="POST" class="space-y-6" x-data="taskForm()">
        <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="w-full rounded-lg border-gray-300 focus:border-brand-500 focus:ring-brand-500"
                        placeholder="توضیحات تسک..."><?php echo e(old('description')); ?></textarea>
                </div>
                    ...
                    <div>
                        ...
                        <select name="team_id" x-model="teamId" @change="loadTeamMembers()"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($team->id); ?>" <?php echo e($currentTeam && $currentTeam->id === $team->id ? 'selected' : ''); ?>>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['low' => ['کم', 'gray'], 'medium' => ['متوسط', 'blue'], 'high' => ['بالا', 'orange'], 'urgent' => ['فوری', 'red']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="relative cursor-pointer">
                            <input type="radio" name="priority" value="<?php echo e($value); ?>" class="peer sr-only" <?php echo e(old('priority', 'medium') === $value ? 'checked' : ''); ?>>
                            <div class="flex flex-col items-center p-3 border-2 rounded-lg transition
                                peer-checked:border-<?php echo e($data[1]); ?>-500 peer-checked:bg-<?php echo e($data[1]); ?>-50
                                hover:bg-gray-50">
                                <span class="w-3 h-3 rounded-full bg-<?php echo e($data[1]); ?>-500 mb-1"></span>
                                <span class="text-xs font-medium"><?php echo e($data[0]); ?></span>
                            </div>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="due_date" value="<?php echo e(old('due_date')); ?>"
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(route('tasks.index', ['team' => $currentTeam?->slug])); ?>"
...
function taskForm() {
    return {
        teamId: '<?php echo e($currentTeam?->id); ?>',
        checklistItems: [],
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Tamironline-CRM/Modules/Task/Resources/views/create.blade.php ENDPATH**/ ?>