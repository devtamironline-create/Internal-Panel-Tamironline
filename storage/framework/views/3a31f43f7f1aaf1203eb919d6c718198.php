<?php $__env->startSection('page-title', 'ایجاد تیم جدید'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <!-- Form -->
    <form action="<?php echo e(route('teams.store')); ?>" method="POST" class="bg-white rounded-xl shadow-sm p-6 space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                placeholder="توضیح کوتاه درباره تیم..."><?php echo e(old('description')); ?></textarea>
            ...
            <div>
                ...
                <div class="grid grid-cols-5 gap-2">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="color" value="<?php echo e($colorKey); ?>" class="sr-only peer" <?php echo e(old('color', 'blue') == $colorKey ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="icon" value="<?php echo e($iconKey); ?>" class="sr-only peer" <?php echo e(old('icon', 'users') == $iconKey ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Tamironline-CRM/Modules/Task/Resources/views/teams/create.blade.php ENDPATH**/ ?>