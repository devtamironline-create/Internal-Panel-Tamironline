<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && auth()->user()->is_staff): ?>
<div x-data="callNotification()" x-init="init()" class="fixed z-[200]">
    ...
    <a href="<?php echo e(route('admin.messenger')); ?>" x-show="unreadCount > 0" class="fixed bottom-6 left-6 bg-brand-500 hover:bg-brand-600 text-white rounded-full p-4 shadow-lg flex items-center gap-2 transition">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Tamironline-CRM/resources/views/components/call-notification.blade.php ENDPATH**/ ?>