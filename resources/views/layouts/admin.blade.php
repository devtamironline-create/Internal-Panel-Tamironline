...
>
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto no-scrollbar py-6">
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('warehouse.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        <a href="{{ route('warehouse.dashboard') }}" class="sidebar-menu-item {{ request()->routeIs('warehouse.dashboard') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            داشبورد
                        </a>
                        <a href="{{ route('warehouse.orders.index') }}" class="sidebar-menu-item {{ request()->routeIs('warehouse.orders.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('warehouse.sync-logs') }}" class="sidebar-menu-item {{ request()->routeIs('warehouse.sync-logs') ? 'sidebar-menu-item-active' : '' }}">
    ...
    <!-- App Install Prompt (Mobile Only) -->
    ...
    function isAppPromptDismissed() {
        const dismissed = localStorage.getItem('app-prompt-dismissed');
        if (!dismissed) return false;
        const daysSinceDismissed = (new Date() - new Date(parseInt(dismissed))) / (1000 * 60 * 60 * 24);
