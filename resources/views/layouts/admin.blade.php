            ...
            <nav class="flex-1 overflow-y-auto no-scrollbar py-6">
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('crm.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('crm.leads.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.leads.index') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/></svg>
                            لیدها
                        </a>
                        <a href="{{ route('crm.leads.dashboard') }}" class="sidebar-menu-item {{ request()->routeIs('crm.leads.dashboard') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('crm.tickets.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.tickets.*') ? 'sidebar-menu-item-active' : '' }}" style="position: relative;">
                            ...
                            تیکت‌های پشتیبانی
                            @php
                                // تعداد تیکت‌هایی که منتظر پاسخ ما هستند
                                // (status=open یعنی تکنسین آخرین پیام را داده).
                                $pendingTicketCount = \Modules\CRM\Models\Ticket::where('status', 'open')->count();
                            @endphp
                        ...
                        <a href="{{ route('crm.feature-flags.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.feature-flags.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('crm.order-settings.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.order-settings.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('crm.technicians.coverage-manage') }}" class="sidebar-menu-item {{ request()->routeIs('crm.technicians.coverage-manage') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            مدیریت پوشش
                        </a>
                        <a href="{{ route('crm.technicians.service-coverage') }}" class="sidebar-menu-item {{ request()->routeIs('crm.technicians.service-coverage') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('crm.proformas.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.proformas.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 7h6m-6 4h6m-6 4h4m1 6H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            پیش‌فاکتورها
                        </a>
                        @endcan
                        ...
                        {{-- ── پیکربندی ── --}}
                        @canany(['view-crm-taxonomies', 'manage-crm-sms-templates', 'manage-crm-push', 'manage-crm-settings'])
                        ...
                        @can('manage-crm-taxonomies')
                        <a href="{{ route('crm.service-matrix.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.service-matrix.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        @endcan
                        @can('manage-crm-settings')
                        <a href="{{ route('crm.app-service-area.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.app-service-area.*') || request()->routeIs('crm.provinces.*') || request()->routeIs('crm.cities.*') || request()->routeIs('crm.regions.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        @endcan
                        @can('manage-crm-push')
                        <a href="{{ route('crm.push.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.push.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                            پوش نوتیفیکیشن
                        </a>
                        @endcan
                        @can('manage-crm-settings')
                        <a href="{{ route('crm.bale-campaigns.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.bale-campaigns.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 20l9-9-9-9-2.5 6.5L3 11l6.5 2.5L12 20z"/></svg>
                            پیام‌رسان بله (کمپین‌ها)
                        </a>
                        <a href="{{ route('crm.notify-templates.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.notify-templates.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 10-12 0v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                            قالب‌های پیام مشتری
                        </a>
                        @endcan
                        @endcanany
                ...
                <div class="mb-2" x-data="{ open: {{ request()->routeIs('admin.staff.*') || request()->routeIs('admin.staff-contracts.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="w-full sidebar-menu-item" style="justify-content: space-between;">
                        <span class="flex items-center gap-3">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('admin.staff.index') }}" class="sidebar-menu-item {{ request()->routeIs('admin.staff.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            مدیریت پرسنل
                        </a>
                        @endcanany
                ...
                <!-- Salary — به‌صورت موقت غیرفعال تا زمان بهره‌برداری مجدد -->
                @if(false) {{-- حقوق و دستمزد موقتاً غیرفعال است تا زمان بهره‌برداری مجدد --}}
                ...
                <!-- سئو -->
                @if(Route::has('seo.admin.settings'))
                @can('manage-seo')
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('seo.admin.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="w-full sidebar-menu-item" style="justify-content: space-between;">
                        <span class="flex items-center gap-3">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        <a href="{{ route('seo.admin.dashboard') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.dashboard') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zM14 12a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z"/></svg>
                            داشبورد سئو
                        </a>
                        <a href="{{ route('seo.admin.settings') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.settings') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            تنظیمات سئو
                        </a>
                        <a href="{{ route('seo.admin.templates.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.templates.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            قالب‌های سئو
                        </a>
                        <a href="{{ route('seo.admin.redirects.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.redirects.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.admin.meta-audit.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.meta-audit.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            بازبینی تایتل و دیسکریپشن
                        </a>
                        <a href="{{ route('seo.admin.audit.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.audit.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            مانیتورینگ سئو
                        </a>
                        <a href="{{ route('seo.admin.broken-links.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.broken-links.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.admin.internal-links.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.internal-links.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 10h16M4 14h10M4 18h10"/></svg>
                            لینک‌سازی داخلی
                        </a>
                        <a href="{{ route('seo.admin.link-fixes.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.link-fixes.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            اصلاح لینک‌های داخلی
                        </a>
                        <a href="{{ route('seo.admin.canonical.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.canonical.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5m6.656-1.328a4 4 0 010-5.656l3-3a4 4 0 015.656 5.656l-1.5 1.5"/></svg>
                            Canonical
                        </a>
                        <a href="{{ route('seo.admin.cannibalization.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.cannibalization.*') ? 'sidebar-menu-item-active' : '' }}">
                            ...
                            هم‌نوع‌خواری کلمات (Cannibalization)
                        </a>
                        <a href="{{ route('seo.admin.tools.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.tools.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.admin.roles.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.admin.roles.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11c0 .552-.448 1-1 1s-1-.448-1-1 .448-1 1-1 1 .448 1 1zm0 0v6m0 0H9m3 0h3M5 7a7 7 0 0114 0"/></svg>
                            دسترسی نقش‌ها
                        </a>
                    </div>
                </div>
                ...
                <!-- بازوی سئو (SEO Command Center) -->
                @if(Route::has('seo.arm.dashboard'))
                @can('manage-seo')
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('seo.arm.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="w-full sidebar-menu-item" style="justify-content: space-between;">
                        <span class="flex items-center gap-3">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        <a href="{{ route('seo.arm.dashboard') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.dashboard') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            مرکز فرمان
                        </a>
                        <a href="{{ route('seo.arm.roadmap.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.roadmap.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>
                            برنامه ۹۰ روزه
                        </a>
                        <a href="{{ route('seo.arm.calendar.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.calendar.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            تقویم محتوا
                        </a>
                        <a href="{{ route('seo.arm.pages.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.pages.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.arm.opportunities.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.opportunities.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.arm.issues.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.issues.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01M5.07 19H19a2 2 0 001.75-2.96l-6.93-12a2 2 0 00-3.5 0l-6.93 12A2 2 0 005.07 19z"/></svg>
                            مشکلات فنی
                        </a>
                        <a href="{{ route('seo.arm.links.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.links.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
                            لینک‌سازی
                        </a>
                        <a href="{{ route('seo.arm.reports.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.reports.*') ? 'sidebar-menu-item-active' : '' }}">
                        ...
                        <a href="{{ route('seo.arm.settings.index') }}" class="sidebar-menu-item {{ request()->routeIs('seo.arm.settings.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            تنظیمات
                        </a>
                    </div>
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('technician.admin.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        <a href="{{ route('technician.admin.dashboard') }}" class="sidebar-menu-item {{ request()->routeIs('technician.admin.dashboard') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            داشبورد تکنسین‌ها
                        </a>
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('site.admin.*', 'crm.devices.*', 'crm.device-categories.*', 'crm.brands.*', 'crm.service-prices.*', 'crm.device-brand-pages.*', 'crm.combo-manager.*', 'crm.city-pages.*', 'crm.cities.pages.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('site.admin.cache.index') }}" class="sidebar-menu-item {{ request()->routeIs('site.admin.cache.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                            پاک‌سازی کش سایت
                        </a>
                        @endcanany
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('site.admin.forum.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('site.admin.forum.topics.index') }}" class="sidebar-menu-item {{ request()->routeIs('site.admin.forum.topics.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 10h16M4 14h10M4 18h6"/></svg>
                            موضوعات
                        </a>
                ...
                <!-- بازاریابی — ردیابی تماس تبلیغات گوگل (دسترسی: view-ads-tracking) -->
                @if(Route::has('admin.marketing.ads-tracking.index'))
                @can('view-ads-tracking')
                <div class="mt-2">
                    <a href="{{ route('admin.marketing.ads-tracking.index') }}"
                       class="sidebar-menu-item {{ request()->routeIs('admin.marketing.ads-tracking.*') ? 'sidebar-menu-item-active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>
                        بازاریابی — Ads Tracking
                    </a>
                </div>
                @endcan
                @endif
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('crm.costs.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('crm.costs.analytics') }}" class="sidebar-menu-item {{ request()->routeIs('crm.costs.analytics') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 12l3-3 4 4 5-5m0 0v4m0-4h-4M3 20h18"/></svg>
                            گزارش حسابداری
                        </a>
                        ...
                        @if(Route::has('crm.google-ads.index'))
                        <a href="{{ route('crm.google-ads.index') }}" class="sidebar-menu-item {{ request()->routeIs('crm.google-ads.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                            گوگل ادز
                        </a>
                        @endif
                ...
                <!-- هوش مصنوعی -->
                @can('manage-ai')
                @if(Route::has('site.admin.ai.index'))
                <a href="{{ route('site.admin.ai.index') }}" class="sidebar-menu-item mt-2 {{ request()->routeIs('site.admin.ai.*') ? 'sidebar-menu-item-active' : '' }}">
                ...
                <div class="mt-6" x-data="{ open: {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') || request()->routeIs('admin.activity-log.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="sidebar-submenu">
                        ...
                        <a href="{{ route('admin.activity-log.index') }}" class="sidebar-menu-item {{ request()->routeIs('admin.activity-log.*') ? 'sidebar-menu-item-active' : '' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                            گزارش فعالیت
                        </a>
            ...
            <header class="sticky top-0 z-30 flex w-full border-b border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
                <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                    ...
                    <div class="flex items-center justify-end gap-4 px-5 py-4 lg:px-0">
                        ...
                        <!-- Dark Mode -->
                        <button @click="darkMode = !darkMode" class="flex-shrink-0 flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-3">
                                <span class="hidden lg:block text-right">
                                    <span class="block text-sm font-medium text-gray-700 dark:text-gray-400" style="width: max-content; flex-shrink: 0;">{{ auth()->user()->full_name ?? 'کاربر' }}</span>
                                </span>
        ...
        $(document).ready(function() {
            $('.jalali-datepicker').each(function() {
                ...
                $input.persianDatepicker({
                    format: 'YYYY/MM/DD',
                    // مقدارِ ازپیش‌پرشدهٔ input شمسی است؛ بدونِ این خط، datepicker
                    // آن را میلادی فرض و دوباره تبدیل می‌کند (مثلاً 1405 → 784).
