        ...
        >
            ...
            <div class="flex items-center justify-between pt-8 pb-7 border-b border-white/10">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                    <!-- Logo Icon -->
                    <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-amber-400 to-orange-500 shadow-lg overflow-hidden">
                        @if($siteLogo)
                            <img src="{{ asset('storage/' . $siteLogo) }}" alt="Logo" class="w-6 h-6 object-contain">
                        @else
