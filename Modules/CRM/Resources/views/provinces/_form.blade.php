...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">نام استان <span class="text-red-500">*</span></label>
    ...
    <div>
        ...
        <input type="text" name="slug" value="{{ old('slug', $province->slug ?? '') }}"
    ...
    <div>
        ...
        <input type="number" name="sort_order" min="0" value="{{ old('sort_order', $province->sort_order ?? 0) }}"
               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-brand-500">
...
<div class="flex items-center gap-3 mt-6">
    ...
    <a href="{{ route('crm.provinces.index') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">انصراف</a>
</div>
