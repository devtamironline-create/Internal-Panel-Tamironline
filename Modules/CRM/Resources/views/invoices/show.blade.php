        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                <div class="text-xs text-red-700 dark:text-red-300 mt-2">
                    آنچه به مشتری داده شده و در کیف‌پول تکنسین نشسته، همین فاکتور است. اگر عدد این
                    فاکتور اشتباه است، از دکمهٔ «✏️ اصلاح مبلغ فاکتور» بالای همین صفحه استفاده کنید —
                    تکمیلِ مجددِ سفارش دیگر فاکتور را تغییر نمی‌دهد.
                </div>
            </div>
        </div>
    </div>
