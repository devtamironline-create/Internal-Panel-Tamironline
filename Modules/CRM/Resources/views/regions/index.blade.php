...
<div class="p-4 md:p-6 max-w-5xl mx-auto">
    <div class="mb-4">
        ...
        <p class="text-xs text-gray-500 mt-1">مناطق ذیل هر شهر — اختیاری. این همان منطقه‌ای است که در ثبت سفارش انتخاب می‌شود. با غیرفعال کردن، منطقه از انتخاب‌های جدید حذف می‌شود (بدون حذف داده).</p>
    </div>
