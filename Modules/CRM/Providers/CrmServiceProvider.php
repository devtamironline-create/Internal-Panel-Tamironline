...
use Modules\CRM\Console\Commands\DiagnoseAutoAssign;
use Modules\CRM\Console\Commands\DiagnoseInvoiceMismatch;
...
use Modules\CRM\Console\Commands\PublishCombo;
...
use Modules\CRM\Console\Commands\RepairContentImages;
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                DiagnoseAutoAssign::class,
                DiagnoseInvoiceMismatch::class,
