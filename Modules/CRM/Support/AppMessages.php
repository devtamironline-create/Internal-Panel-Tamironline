...
final class AppMessages
{
    ...
    public const DEFAULTS = [
        ...
        'overdue_no_answer' => 'مشتری پاسخگو نبوده است. تا ۲۴ ساعت پس از تخصیص باید نتیجهٔ نهایی مشخص شود.',
        ...
        'overdue_awaiting_part' => 'پنج روز از انتظار قطعه گذشته. وضعیت نهایی را مشخص کنید.',
        ...
        // ─── بازبینی برگشتی — بعد از مراجعه در محل ثبت می‌شود؛ تا آن موقع
        // فقط بنرِ یادآور است و هماهنگی/مراجعه آزاد. بستنِ سفارش بدون ثبتِ
        // بررسی سمتِ سرور بلاک است.
        'return_review_title' => 'بررسی سفارش برگشتی',
        'return_review_body' => 'ابتدا مثل یک سفارش عادی با مشتری هماهنگ و مراجعه کنید؛ سپس بعد از دیدن دستگاه مشخص کنید ایراد از خدمات قبلی بوده یا مشکل تازه‌ای است. تا قبل از ثبت این بررسی، امکان بستن سفارش وجود ندارد.',
