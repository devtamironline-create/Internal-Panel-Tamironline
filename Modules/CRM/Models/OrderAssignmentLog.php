...
class OrderAssignmentLog extends Model
{
    ...
    public const MODES = [
        ...
        // هیچ تکنسینی پوششش نمی‌دهد. این حالت با «امتیاز کم» فرق دارد و
        // خودبه‌خود حل نمی‌شود: تا وقتی تگ‌های پوشش عوض نشوند، این سفارش
        // هرگز خودکار پخش نخواهد شد و باید دستی اقدام شود.
        'unassignable' => 'پخش نشد — هیچ تکنسین واجد شرایطی نبود',
    ];
