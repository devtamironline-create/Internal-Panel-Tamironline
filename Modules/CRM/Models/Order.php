...
class Order extends Model
{
    ...
    public const CANCEL_REASONS = [
        ...
        'دستگاه باز و دست خورده بود',
        'دستگاه بازدید شد مشکلی نداشت',
        'دستگاه دارای گارانتی بوده',
        'فقط استعلام هزینه خدمات می‌خواستند',
        'از واحد دیگری خدمات دریافت کردند',
        'تصمیم به تعویض دستگاه گرفتند',
        'مشکل برطرف شده',
        'کنسل به دلیل عدم پاسخگویی مشتری',
        'مشتری از دریافت خدمات منصرف شدند',
        'مشتری تلفنی راهنمایی شد',
