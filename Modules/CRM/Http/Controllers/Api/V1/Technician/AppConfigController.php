    ...
    public function __invoke(): JsonResponse
    {
        return response()->json([
            ...
            'data' => [
                ...
                // علت‌های «ردِ سفارش توسطِ تکنسین» — لیستِ انتخابیِ قابلِ
                // مدیریتِ ادمین (مستقل از «کنسل»ِ ادمین). هر آیتم label دارد و
                // reopen: اگر true، ردِ سفارش با آن علت، سفارش را از تکنسین
                // می‌گیرد و برای تخصیصِ مجدد باز می‌کند. اپ label را در مودالِ
                // رد نشان می‌دهد و مقدارِ انتخاب‌شده را در فیلدِ `decline_reason`
                // (یا `cancel_reason` برای سازگاری) می‌فرستد.
                'decline_reasons' => Order::declineReasons(),
