...
class PaymentController extends Controller
{
    ...
    /**
     * «مستقیم به درگاه» — نسخهٔ یک‌کلیکهٔ initiate برای اپ‌ها: کاربر از
     * اپ می‌آید و بدونِ دیدنِ صفحهٔ پیش‌نمایش و کلیکِ دوم، مستقیم به
     * درگاه هدایت می‌شود. GET است تا از اپ لینک‌شدنی باشد؛ حالت‌های خطا
     * (پرداخت‌شده/لغو/صفر/درگاهِ خاموش) همان صفحه‌های خوانا را می‌دهند.
     */
    public function direct(Request $request, string $invoiceCode)
    {
        return $this->initiate($request, $invoiceCode);
    }
