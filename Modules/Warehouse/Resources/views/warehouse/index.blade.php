...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        ...
        {{-- AMADEST STATUS: Table with Amadest-specific info --}}
        @elseif($currentStatus === 'amadest')
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-purple-50">
                    <tr>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">شماره سفارش</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">مشتری</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">شناسه آمادست</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">کد رهگیری</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">تاریخ ثبت</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-purple-600 uppercase">عملیات</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    @forelse($orders as $order)
                    <tr class="hover:bg-purple-50/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-bold bg-purple-100 text-purple-700 rounded-lg" dir="ltr">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                                {{ $order->amadest_barcode }}
                            </span>
                            @else
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-1">
                                ...
                                <form action="{{ route('warehouse.status', $order) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="p-2 text-gray-600 hover:text-cyan-600 hover:bg-cyan-50 rounded-lg" title="انتقال به: آماده ارسال" onclick="return confirm('انتقال به وضعیت «آماده ارسال»؟')">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            <svg class="w-12 h-12 mx-auto text-purple-200 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                            <p class="font-medium">سفارشی در وضعیت آمادست وجود ندارد</p>
                            <p class="text-sm mt-1">سفارشات پستی پس از ثبت در آمادست اینجا نمایش داده می‌شوند</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
