        ...
        <div class="bg-white rounded-xl shadow-sm p-6 lg:col-span-2">
            ...
            <form action="{{ route('warehouse.settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">استان فرستنده</label>
                        <input type="text" name="invoice_sender_province" value="{{ $invoiceSettings['invoice_sender_province'] ?? '' }}"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm"
                               placeholder="تهران">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">شهر فرستنده</label>
                        <input type="text" name="invoice_sender_city" value="{{ $invoiceSettings['invoice_sender_city'] ?? '' }}"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm"
                               placeholder="منطقه ۱۵ پستی تهران">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">کدپستی فرستنده</label>
                        <input type="text" name="invoice_sender_postcode" value="{{ $invoiceSettings['invoice_sender_postcode'] ?? '' }}" dir="ltr"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm"
                               placeholder="1566855711">
                    </div>
