...
class WarehouseOrder extends Model
{
    ...
    public static function statusLabels(): array
    {
        return [
            ...
            self::STATUS_PRINTED => 'پرینت شده',
            self::STATUS_PACKING => 'بسته‌بندی',
    ...
    public static function statusColors(): array
    {
        return [
            ...
            self::STATUS_PRINTED => 'purple',
            self::STATUS_PACKING => 'yellow',
    ...
    public static function statusIcons(): array
    {
        return [
            ...
            self::STATUS_PRINTED => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/>',
            self::STATUS_PACKING => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>',
    ...
    public static function nextStatus(string $current): ?string
    {
        $flow = [
            ...
            self::STATUS_PREPARING => self::STATUS_PRINTED,
            self::STATUS_PRINTED => self::STATUS_PACKING,
            self::STATUS_PACKING => self::STATUS_PACKED,
    ...
    public function updateStatus(string $newStatus): self
    {
        ...
        match ($newStatus) {
            self::STATUS_PRINTED => $this->printed_at = now(),
