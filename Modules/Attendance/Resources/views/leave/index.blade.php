...
@section('page-title', 'مرخصی‌های من')
@section('main')
<div class="space-y-6">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <a href="{{ route('leave.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-600">{{ $stats['annual_balance'] }} روز</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600">{{ $stats['sick_balance'] }} روز</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ $stats['approved_this_year'] }} روز</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-{{ $request->leaveType->type_color }}-50">
                                    <svg class="w-4 h-4 text-{{ $request->leaveType->type_color }}-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $request->leaveType->type_icon }}"/>
                                    </svg>
                                </span>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $request->jalali_end_date }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">{{ $request->duration_text }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('leave.show', $request) }}" class="text-blue-600 hover:text-blue-700">
                                    جزئیات
                                </a>
