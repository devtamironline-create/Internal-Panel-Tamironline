...
class RegistrationController extends Controller
{
    ...
    public function storeStep3(Request $request)
    {
        $request->validate([
            ...
            'colleague1_name'      => ['required', 'string', 'max:255'],
            'colleague1_phone'     => ['required', 'string', 'max:20'],
            'colleague2_name'      => ['required', 'string', 'max:255'],
            'colleague2_phone'     => ['required', 'string', 'max:20'],
