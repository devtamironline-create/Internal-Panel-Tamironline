...
class TechnicianSetting extends Model
{
    ...
    {
        return [
            'page_title'         => 'همکاری با تامیرانلاین',
            'hero_title'         => 'به تیم تکنسین‌های ما بپیوندید',
            'hero_subtitle'      => 'کار آزاد، درآمد خوب، در شهر خودت',
            'hero_description'   => 'تامیرانلاین به تکنسین‌های حرفه‌ای در رشته‌های برق، تاسیسات، سرمایش و گرمایش، لوله‌کشی و دیگر حوزه‌های فنی نیاز دارد. با ما همکار شو و درآمد خود را افزایش بده.',
            'hero_cta_text'      => 'همین حالا ثبت‌نام کن',
            'hero_badge'         => 'جدیدترین فرصت شغلی',
            'benefits_title'     => 'چرا با تامیرانلاین همکار شوی؟',
