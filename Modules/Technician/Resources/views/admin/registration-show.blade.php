...
@php
    $statusLabels = ['incomplete' => 'ناقص', 'pending' => 'در انتظار بررسی', 'approved' => 'تایید شده', 'rejected' => 'رد شده', 'final_approved' => 'تایید نهایی'];
    $statusColors = ['incomplete' => 'gray', 'pending' => 'amber', 'approved' => 'green', 'rejected' => 'red', 'final_approved' => 'emerald'];
