    ...
    <div class="min-h-screen flex flex-col mx-auto w-full max-w-[480px] bg-white shadow-[0_0_30px_rgba(0,0,0,0.06)]">
        ...
        <div class="px-6 py-5 flex-1">
            ...
            <div id="phaseC2" class="phase">
                ...
                <div class="space-y-4">
                    {{-- تذکر الزامی بودن کارت ملی در دست --}}
                    <div class="bg-amber-50 border border-amber-300 rounded-xl p-4">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="text-sm font-bold text-amber-800 mb-1">مهم — قبل از ضبط ویدیو بخوانید:</p>
                                <p class="text-xs text-amber-800 leading-relaxed">
                                    هنگام ضبط ویدیو حتماً <b>کارت ملی</b> خود را در دست داشته باشید و طوری جلوی دوربین بگیرید که <b>تصویر کارت به‌وضوح در دوربین دیده شود</b>. در صورت عدم نمایش کارت ملی، ویدیو شما رد خواهد شد.
                                </p>
                            </div>
                        </div>
                    </div>
