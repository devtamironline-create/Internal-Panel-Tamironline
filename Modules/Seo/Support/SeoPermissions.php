...
class SeoPermissions
{
    ...
    public static function labels(): array
    {
        return [
            ...
            'seo-arm-view' => [
                'label' => 'مشاهدهٔ بازوی سئو',
                'description' => 'دیدنِ مرکز فرمان، برنامهٔ ۹۰ روزه، تقویم محتوا و گزارش‌ها.',
            ],
            'seo-arm-manage' => [
                'label' => 'مدیریت بازوی سئو',
                'description' => 'تغییر وضعیت کارها/محتوا، ویرایش صفحات و کلمات، لینک‌سازی و تنظیمات بازو.',
            ],
        ];
    }
