...
<div class="p-6">
    ...
    @php
        $cards = [
            ['route' => 'site.admin.pages.index',            'permission' => 'manage-site-pages',           'title' => 'صفحات سایت',     'desc' => 'صفحاتی مانند درباره ما، تماس و خدمات.', 'count' => $stats['pages'],         'color' => 'blue',    'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
            ...
            ['route' => 'site.admin.testimonials.index',     'permission' => 'manage-site-testimonials',    'title' => 'نظرات مشتریان',  'desc' => 'مخزن نظرات؛ به‌ هر صفحه قابل اتصال.',     'count' => $stats['testimonials'],  'color' => 'emerald', 'icon' => 'M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z'],
