...
@section('page-title', 'افزودن آمار')
...
<div class="p-6 max-w-3xl">
    ...
    <form method="POST" action="{{ route('site.admin.about-stats.store') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        @csrf
        <h1 class="text-xl font-bold mb-4">افزودن آمار</h1>
        @include('site::admin.about-stats._form')
