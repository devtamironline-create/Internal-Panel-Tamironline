...
<div class="p-6 max-w-3xl">
    ...
    <form method="POST" action="{{ route('site.admin.banners.update', $banner->id) }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        @csrf @method('PUT')
        <h1 class="text-xl font-bold mb-4">ویرایش بنر</h1>
