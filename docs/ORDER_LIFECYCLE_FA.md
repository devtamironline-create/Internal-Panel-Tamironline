...
> **قاعده طلایی (حکم ۱۴۰۵/۰۵/۲۹):** تکمیلِ سفارش در **هیچ حالتی** فاکتور قبلی را باطل نمی‌کند و هیچ تعدیلی (برگشت کمیسیون) نمی‌زند. باطل‌کردن + برگشت خودکار فقط در دو جا وجود دارد: دکمه «اصلاح مبلغ فاکتور» و «لغو فاکتور».

| سناریو | رفتار سیستم |
|---|---|
| **بستن مجدد دورِ بازگشتی** (بررسی تکنسین ثبت شده — چه گارانتی=۰ چه ایراد جدید با هزینه) | فاکتور **جمع‌شونده**: فاکتور جدید کنار قبلی؛ هیچ‌چیز باطل نمی‌شود، هیچ تعدیلی ثبت نمی‌شود؛ بدهی تکنسین جمع سهم شرکت همه؛ مشتری همه را کنار هم می‌بیند (`other_invoices`). |
| **تکمیل مجدد خارج از چرخه بازگشتی** | هیچ اتفاق مالی — فاکتور قبلی دست‌نخورده می‌ماند (idempotent). اگر مبلغ عوض شده، بنر مغایرت هشدار می‌دهد و مسیر درست دکمه «اصلاح مبلغ فاکتور» است. |
